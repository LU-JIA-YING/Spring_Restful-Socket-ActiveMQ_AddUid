...
public class MQConfig {
    ...
    public ActiveMQConnectionFactory activeMQConnectionFactory() {
        ...
        topicPolicy.setRedeliveryDelay(100000);
...
//        template.setDestinationResolver(destinationResolver());
        ...
        template.setReceiveTimeout(10000);  //jmsTemplate的接收是阻塞式的接收，默認會一直阻塞等待，直到接收到了消息。也可以設置一個最長的等待時間參數，超過這個時間，接收的方法將得到null的結果。
        return template;
    }
